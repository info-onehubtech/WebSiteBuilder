...
function Editor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/api/create-site`, data, {
        headers: {
        ...
        <form onSubmit={handleSubmit} style={{
          ...
          {formData.templateId && (
            <div style={{ marginTop: '2rem', textAlign: 'center' }}>
                <img
                  src={`${API_URL}/api/templates/${formData.templateId}/template.png`}
                  alt="Template Preview"
                  ...
                  onError={e => {
                    e.target.onerror = null;
                    e.target.src = `${API_URL}/api/via.placeholder.com/120x80?text=No+Image`;
                  }}
                />
              ...
              {showModal && (
                <div style={{
                  ...
                  <img
                    ...
                    onError={e => {
                      e.target.onerror = null;
                      e.target.src = `${API_URL}/api/via.placeholder.com/220x140?text=No+Image`;
                    }}
                  />
                </div>
              )}
